...
//--- プロトタイプ宣言
void CreateGeometoryBox(void);
void CreateGeometorySphere(void);
void CreateGeometoryCylinder(void);
void CreateGeometoryCapsule(void);
void CreateGeometoryCone(void);
void CreateGeometoryShader(void);
void CreateGeometoryConstantBuffer(void);
void UpdateGeometoryMatrix(void);
